    ...
    <div class="sub-category__content flex">
        ...
        <div class="sub-category__right">
            ...
            <div class="filters">
                ...
                <div class="settings">
                    <div class="_popularity active">По популярности<span></span></div>
                    <div class="_naming">Названию<span></span></div>
                    <div class="_price">Цене<span></span></div>
                    <div class="settings__item">
                        <input type="checkbox" name="exist" id="exist" checked> В наличии</div>
                    <div class="settings__item">
                        <input type="checkbox" name="discont" id="discont"> Со скидкой</div>
                    <div class="settings__item">
                        <input type="radio" name="grid" id="grid" class="grid-type" checked>
                        <input type="radio" name="row" id="row" class="row-type">
                    </div>
                </div>
            </div>
